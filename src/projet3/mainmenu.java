...
public class mainmenu extends JFrame  {
   ...
   p= new JPanel(new FlowLayout(1,1,4));         
         np= new JPanel(new BorderLayout());
         pnp= new JPanel(new GridLayout(1,5));
         wp = new JPanel(new GridLayout(4,2));
         ep= new JPanel();
         sp= new JPanel();
...
//               sp.setBorder(title3);
   ...
   p= new JPanel(new FlowLayout(1,1,4));         
    ...
    table.setEnabled(false);
               // TitledBorder title3;
               // title3= BorderFactory.createTitledBorder("Details Achats");
    ...
    // RECUS    
     ...
     if (ob == i15 ){
       getContentPane().removeAll();
            ...
            JPanel p,ep,wp,np,pnp,pwr,rd;
            JRadioButton r1,r2,r3;
            JLabel l1,l2,l3,l4,cl,r; 
            JButton b1,b2,b3;
            JComboBox c;
            JTextArea t;
            JTextField f1,f2,f3,f4;
   ...
   p= new JPanel(new FlowLayout(1,1,4));         
         ...
         wp = new JPanel(new GridLayout(4,2));
         ep= new JPanel();
         pwr = new JPanel(new BorderLayout());
         rd= new JPanel(new GridLayout(1,4)); 
      ...
      add(p); 
           ...
           p.setPreferredSize(new Dimension(850,700));
              ...
              wp.add(l3);wp.add(f3);
              wp.add(l4);wp.add(f4);
              rd.add(r);rd.add(r1);rd.add(r2);rd.add(r3);
              
              pwr.add(wp, BorderLayout.NORTH);
              pwr.add(rd, BorderLayout.SOUTH);
              
              
              ep.add(t);
              
            p.add(np,BorderLayout.NORTH);
            p.add(pwr,BorderLayout.WEST);
            p.add(ep,BorderLayout.EAST);
